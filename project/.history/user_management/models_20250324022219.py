...
class TeamMember(models.Model):
    ...
    image = models.ImageField(upload_to='team_images/', null=True, blank=True)  # إضافة حقل الصورة
    created_at = models.DateTimeField(auto_now_add=True)  # تأكد من وجود الحقل هنا
